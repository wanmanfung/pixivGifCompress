export const successIcon = `<svg viewBox="64 64 896 896" 
  focusable="false" 
...
export const warningIcon = `<svg viewBox="64 64 896 896" focusable="false" data-icon="warning" width="1em" height="1em" fill="currentColor" aria-hidden="true">
